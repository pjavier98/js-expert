...
assert.throws(() => myObj.add.apply({}, []), { name: 'TypeError', message: 'Vixx' });
...
// feio pra ..., tudo é Object, mas Object adicionando prop para uma function?
...
// com reflection, uma excessão é lançada
